...
public class EnergyBottleDispenserController : StationFacility, IPreviewInitializable
{
    ...
    public Color activeLightColor = new Color(1f, 0.92f, 0.25f);
    ...
    {
        facilityType = FacilityType.EnergyBottleDispenser;
        base.Start();
    ...
    public override void ProcessInteraction(Person person)
    {
        ...
        {
            Debug.LogError("EnergyBottleDispenserController has no bottle prefab assigned.", this);
            return;
        }

        if (startPos == null || endPos == null)
        {
            Debug.LogError("EnergyBottleDispenserController is missing StartPos or EndPos.", this);
            return;
        }
    ...
    {
        SetNeedIconActive(facilityIcon, Passenger.NeedType.Energy);
        SetLightState(true);
        SpawnBottleAtStart();
